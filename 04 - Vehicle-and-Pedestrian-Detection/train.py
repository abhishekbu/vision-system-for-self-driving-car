...
# Settings 
training_dataset = './data/train.tfrecord'
testing_dataset = './data/test.tfrecord'
...
def main():
    ...
    callbacks = [
        ...
        ModelCheckpoint('./saved_models/yolov3_all.tf',
                        verbose=1, save_weights_only=True, monitor='val_loss', mode='min', save_best_only=True),
